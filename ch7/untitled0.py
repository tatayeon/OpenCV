...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov  6 11:07:13 2024
...
mlp_sgd.add(Dense(units=256, activation="tanh", input_shape=(512,)))
mlp_sgd.add(Dense(units=128, activation="tanh", input_shape=(256,)))
